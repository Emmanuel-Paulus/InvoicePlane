<script>
    ...
    var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        url: '<?php echo site_url('upload/upload_file/' . $incom->provider_id . '/' . $incom->incom_url_key) ?>',
        params: {
        ...
        init: function () {
            thisDropzone = this;
            $.getJSON('<?php echo site_url('upload/upload_file/' . $incom->provider_id . '/' . $incom->incom_url_key) ?>',
                function (data) {
    ...
    myDropzone.on('addedfile', function (file) {
        ...
        createDownloadButton(file, '<?php echo site_url('upload/get_file/' . $incom->incom_url_key . '_') ?>' +
    ...
    myDropzone.on('removedfile', function (file) {
        $.post({
            url: '<?php echo site_url('upload/delete_file/' . $incom->incom_url_key) ?>',
            data: {
                name: file.name,
