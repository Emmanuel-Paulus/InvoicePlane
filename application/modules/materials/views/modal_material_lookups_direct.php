        ...
        $('.select-items-confirm').click(function () {
            ...
            $.post("<?php echo site_url('materials/ajax/process_material_selections'); ?>", {
                ...
                for (var key in items) {
                    ...
                    last_item_row.find('input[name=item_price]').val(items[key].material_price_raw);
                    last_item_row.find('input[name=item_quantity]').val(items[key].material_price_raw);
                    last_item_row.find('select[name=item_tax_rate_id]').val(items[key].material_price_amount);
                    last_item_row.find('input[name=material_id]').val(items[key].material_id);
                    last_item_row.find('input[name=picture_id]').val(items[key].picture_id);
