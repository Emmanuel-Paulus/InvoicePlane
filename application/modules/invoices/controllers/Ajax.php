        ...
        if ($this->mdl_invoices->run_validation('validation_rules_save_invoice')) {
            ...
            foreach ($items as $item) {
                ...
                if (!empty($item->item_name)) {
                    ...
                    $item->item_material_id = (isset($item->item_material_id) && $item->item_material_id ? $item->item_material_id : null);
                    if (property_exists($item, 'item_date')) {
                        $item->item_date = ($item->item_date ? date_to_mysql($item->item_date) : null);
                    }
                    $item->item_product_unit_id = (isset($item->item_product_unit_id) && $item->item_product_unit_id ? $item->item_product_unit_id : null);
